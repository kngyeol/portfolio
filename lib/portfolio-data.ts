...
export const projects: Project[] = [
  ...
  },
  {
    ...
    organization: "건국대학교",
    description:
      "외국인 관광객을 위한 한국 음식점 메뉴판 인식 수업 과제. 사전학습 모델을 조합해 음식 분류와 메뉴판 텍스트 인식을 연결했다.",
    highlights: [
      "사전학습 MobileNetV2로 음식 분류 적용",
      "EasyOCR로 한국어/영어 메뉴판 텍스트 인식 연동",
      "클릭한 메뉴 항목을 번역 검색으로 연결",
    ],
    role: ["수업 과제"],
    techStack: ["PyTorch", "MobileNetV2", "EasyOCR"],
    category: "AI / 컴퓨터비전",
    status: "completed",
